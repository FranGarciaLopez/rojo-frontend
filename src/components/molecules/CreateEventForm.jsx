...
export const CreateEvent = () => {
        ...
        try {
            ...
            if (photoResponse.status === 200) {
                ...
                const eventResponse = await axios.post(
                    "https://rojo-backend.onrender.com://dashboard.render.com/events/eventregister",
                    formDataEvent,
                    {
                        headers: {
    ...
    useEffect(() => {
        const fetchCities = async () => {
            try {
                const response = await axios.get("https://rojo-backend.onrender.com://dashboard.render.com/cities/cities");
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get("https://rojo-backend.onrender.com://dashboard.render.com/categories/categories");
