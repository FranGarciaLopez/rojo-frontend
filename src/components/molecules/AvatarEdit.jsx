            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
                ...
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <button
                        ...
                        className={`py-2 px-6 w-full bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 ${loading ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        disabled={loading}
                    >
